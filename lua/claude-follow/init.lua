...
M.setup = function(opts)
  ...
  -- Default keymaps (can be disabled with opts.setup_keymaps = false)
  if opts.setup_keymaps ~= false then
    local keymap_prefix = opts.keymap_prefix or "<leader>cf"
    vim.keymap.set("n", keymap_prefix, M.toggle, { desc = "Toggle Claude Follow Mode" })
    vim.keymap.set("n", keymap_prefix .. "e", M.enable, { desc = "Enable Claude Follow Mode" })
    vim.keymap.set("n", keymap_prefix .. "d", M.disable, { desc = "Disable Claude Follow Mode" })
    vim.keymap.set("n", keymap_prefix .. "s", M.status, { desc = "Claude Follow Mode Status" })
  end
end
